...
export class InitialSchema1652800321507 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`appointments\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`customer_id\` bigint NOT NULL, \`mechanic_id\` bigint NOT NULL, \`status\` varchar(50) NOT NULL, \`type\` varchar(50) NOT NULL,\`date\` varchar(200) NOT NULL, \`amount\` bigint NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    }
