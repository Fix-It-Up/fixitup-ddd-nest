...
export class MechanicFactory {
    public static createFrom(id: MechanicId, mechanicName: MechanicName, email: Email, password: Password, address: MechanicAddress, description: MechanicDescription): Mechanic {
